<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: transparent!important;">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto navbar-center ">
			<li color ="black ; font-weight: bold;"><a href="index.php?dossier=Entreprise&controller=entrepriselocation&function=entrepriselocation1">Consultation des voitures</a></li>
			<li color ="black ; font-weight: bold;"><a href="index.php?dossier=Entreprise&controller=entreprisehistorique&function=entreprisehistorique">Historique</a></li>
