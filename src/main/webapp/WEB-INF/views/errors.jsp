...
<nav data-state="closed">
    <ul>
        ...
        <li>
            <a href="/catalog">Consultation du catalogue</a>
        </li>
        <li>
    ...
    <div class="container">
        <div class="row">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                        ...
                        <g id="planet">
                            ...
                            <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3"
                                    stroke-miterlimit="10" cx="591.743"
                                    cy="158.918" r="7.989"/>
					...
					C278.993,441.286,286.836,447.55,296.315,452.273z"/>
                            ...
                            <g id="head">
                                ...
                                <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)" fill="#FFFFFF"
                                         stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                         stroke-linejoin="round"
            ...
            <div class="col-md-6 align-self-center">
                <h1>Erreur 404</h1>
                <h2>Oups !</h2>
                <p>La page que vous cherchez ne semble plus disponible.
                    Pour retourner à la page d'accueil, cliquez sur le bouton ci-dessous.
                </p>
                <a class="btn green" href="/">Accueil</a>
            </div>
        </div>
    </div>
</main>
